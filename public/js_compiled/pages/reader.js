...
function _initImages() {
  _initImages = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var forced,
      wrapper,
      toLoadImages,
      loadedImg,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            forced = _args.length > 0 && _args[0] !== undefined ? _args[0] : false;
            _context.prev = 1;
            _context.next = 4;
...
function doImages() {
  ...
  var _loop = function _loop() {
    ...
    // Set source
    var proxySrc = "/proxy-image?url=".concat(encodeURIComponent(url), "&referer=").concat(location.href.includes("manga2") ? "manga2" : location.href.includes("manga1") ? "manga1" : location.href.includes("mangahere") ? "mangahere" : "null").concat(bypassCache ? "&c=".concat(+Date.now()) : "");
...
function _getImageUrls() {
  _getImageUrls = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var loc,
      forceFetch,
      key,
      cache,
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            loc = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : location.href;
            forceFetch = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : false;
            // Prepare storage
            key = "image-cache";
            ...
            return _context2.abrupt("return", cache[url].images);
          case 10:
            _context2.prev = 10;
            _context2.next = 13;
            return fetch(url);
...
function _showBigImage() {
  _showBigImage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(images) {
